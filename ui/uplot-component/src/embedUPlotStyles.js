// Embed the uplot styles manually because it requires embedding the styles with a style tag link
let embedded = false;
export function embedUPlotStyles() {
    if (embedded) {
        return;
    }
